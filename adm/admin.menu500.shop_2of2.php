...
$menu['menu500'] = array (
    array('500000', '쇼핑몰현황/기타<br>(注文情報)', G5_ADMIN_URL.'/shop_admin/itemsellrank.php', 'shop_stats'),
    ...
    array('500120', '주문내역출력<br>(注文情報の閲覧)', G5_ADMIN_URL.'/shop_admin/orderprint.php', 'sst_print_order', 1),
