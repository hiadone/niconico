...
$bn_position = (isset($_GET['bn_position']) && in_array($_GET['bn_position'], array('메인', '하단'))) ? $_GET['bn_position'] : '';
...
<div class="local_ov01 local_ov">
    ...
    <select name="bn_position" id="bn_position">
        ...
        <option value="하단"<?php echo get_selected($bn_position, '하단', true); ?>>하단</option>
    </select>
