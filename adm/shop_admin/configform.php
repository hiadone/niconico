...
<section id ="anc_scf_payment">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr class="pg_info_fld kcp_info_fld" id="kcp_info_anchor">
            ...
            <td>
                <?php echo help("NHN KCP 에서 받은 영대문자, 숫자 혼용 총 5자리 SITE CODE 를 입력하세요.예) JP9A3"); ?>
                <input type="text" name="de_kcp_mid" value="<?php echo $default['de_kcp_mid']; ?>" id="de_kcp_mid" class="frm_input code_input" size="8" maxlength="5"> 영대문자, 숫자 혼용 5자리
            </td>
        </tr>
        ...
        <tr class="pg_info_fld lg_info_fld" id="lg_info_anchor">
            ...
            <td>
                <?php echo help("LG유플러스에서 받은 상점 ID를 입력하세요. 예) jp_lguplus\n<a href=\"".G5_ADMIN_URL."/config_form.php#anc_cf_cert\">기본환경설정 &gt; 본인확인</a> 설정의 LG유플러스 상점아이디와 동일합니다."); ?>
                <input type="text" name="cf_lg_mid" value="<?php echo $config['cf_lg_mid']; ?>" id="cf_lg_mid" class="frm_input code_input" size="15" maxlength="20"> 영문자, 숫자 혼용
            </td>
        </tr>
        ...
        <tr class="pg_info_fld inicis_info_fld" id="inicis_info_anchor">
            ...
            <td>
                <?php echo help("KG이니시스로 부터 발급 받으신 상점아이디(MID) 10자리를 입력 합니다. 예) JP1paytest"); ?>
                <input type="text" name="de_inicis_mid" value="<?php echo $default['de_inicis_mid']; ?>" id="de_inicis_mid" class="frm_input code_input" size="15" maxlength="10"> 영문소문자(숫자포함 가능)
            </td>
        </tr>
        ...
        <tr class="kakao_info_fld">
            ...
            <td>
                <?php echo help("카카오페이로 부터 발급 받으신 상점아이디(MID) 10자리를 입력 합니다. 예) KHSIRtestm"); ?>
                <input type="text" name="de_kakaopay_mid" value="<?php echo $default['de_kakaopay_mid']; ?>" id="de_kakaopay_mid" class="frm_input code_input" size="15" maxlength="10">
            </td>
        </tr>
        <tr class="kakao_info_fld">
...
<section id="anc_scf_delivery">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <select name="de_send_cost_case" id="de_send_cost_case">
                    <option value="개수" <?php echo get_selected($default['de_send_cost_case'], "개수"); ?>>개수별차등</option>
		...
		<tr>
            <th scope="row"><label for="de_send_cost_case">자동배송완료</label></th>
            <td>
				<?php
					$acsv = 0;
					$de_acsvDay = "";
					if ((int)$default['de_autoCompleteShipDay'] > 0) {
						$acsv = 1;
						$de_acsvDay = (int)$default['de_autoCompleteShipDay'];
					}
				?>
                <input type="radio" name="de_acsv" value="1" id="de_acsv_1" <?php if ($acsv == 1) { echo "checked"; } ?> >
				<label for="de_acsv_1"><span>'배송중'으로 상태 변경한 뒤
					<input type="text" class="frm_input" size="2" name="de_acsvDay" value="<?php echo $de_acsvDay; ?>" style="text-align:center;">일 후 자동으로 '배송완료'로 주문상태 변경</span></label>
				<br>
				<input type="radio" name="de_acsv" value="2" id="de_acsv_2" <?php if ($acsv == 0) { echo "checked"; } ?>>
				<label for="de_acsv_2"><span>사용안함</span></label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <th scope="row"><label for="de_send_cost_limit">배송비 상한개수</label></th>
            <td>
                <?php echo help("배송비유형이 '개수별차등'일 경우에만 해당됩니다.\n\n예를 들어 7개 미만일 경우 20,000원, 13개 미만일 경우 40,000원 으로 사용할 경우에는 배송비상한개수를 7개;13개 로 입력하고 배송비를 20000;40000 으로 입력합니다."); ?>
                <input type="text" name="de_send_ea_limit" value="<?php echo $default['de_send_ea_limit']; ?>" size="40" class="frm_input" id="de_send_ea_limit">
            </td>
        </tr>
        <tr>
...
<section id="anc_scf_etc">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="de_cart_keep_term">의약품 1회 구매 가능 개수</label></th>
            <td>
                 <?php echo help("의약품 카테고리의 상품을 1회에 최대 가능 개수를 입력하세요. (0 = 제한없음) "); ?>
                <input type="text" name="de_cate40LimitCnt" value="<?php echo $default['de_cate40LimitCnt']; ?>" id="de_cate40LimitCnt" class="frm_input" size="5"> 개
            </td>
        </tr>
        <tr>
		...
		<tr>
            <th scope="row">쇼핑 공지 내용</th>
            <td><?php echo editor_html('de_shoping_notice', get_text(html_purifier($default['de_shoping_notice']), 0)); ?></td>
        </tr>
		<?php
			/*
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <select id="cf_sms_use" name="cf_sms_use">
					...
					<option value="sendgo" <?php echo get_selected($config['cf_sms_use'], 'sendgo'); ?>>보내고</option>
                </select>
            </td>
        </tr>
        <tr>
...
function fconfig_check(f)
{
	...
	<?php echo get_editor_js('de_shoping_notice'); ?>
