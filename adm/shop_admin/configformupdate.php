...
'de_shoping_notice',
'de_cate40LimitCnt',			// 의약품 카테고리 1회 구매 가능 개수
'de_acsv',						// 자동배송완료 사용여부
'de_acsvDay'					// 자동배송완료 일수
);
...
$de_autoCompleteShipDay = 0;
if ($_POST['de_acsv'] == 1) {
	$de_autoCompleteShipDay = $_POST['de_acsvDay'];
}
...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$de_admin_company_owner}',
				...
				de_send_ea_limit              = '{$de_send_ea_limit}',
				...
				de_shoping_notice			  = '{$_POST['de_shoping_notice']}',
				de_cate40LimitCnt			  = '{$_POST['de_cate40LimitCnt']}',
				de_autoCompleteShipDay		  = '{$de_autoCompleteShipDay}'
                ";
sql_query($sql);
