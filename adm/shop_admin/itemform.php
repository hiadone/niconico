...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row">관리자/회원 전용</th>
            <td colspan="2">
				<?php
					$isOnlyAdmin = false;
					$isOnlyMember = false;
					$viewLevel = $it['it_isOnlyAdmin'];
					if ($viewLevel >= 10) {
						$isOnlyAdmin = true;
					} elseif ($viewLevel >= 2 && $viewLevel < 10) {
						$isOnlyMember = true;
					}
				?>
                <?php echo help("체크한 등급에게만 노출 및 구매 가능하도록 합니다. 아무것도 체크하지 않으면 비회원도 구매가 가능합니다."); ?>
                <input type="checkbox" name="it_isOnlyAdmin" value="10" <?php echo ($isOnlyAdmin ? "checked" : ""); ?> id="it_isOnlyAdmin">
                <label for="it_isOnlyAdmin" style="margin-right:15px;">관리자에게만 노출, 구매 가능</label>

				<input type="checkbox" name="it_isOnlyMember" value="2" <?php echo ($isOnlyMember ? "checked" : ""); ?> id="it_isOnlyMember">
                <label for="it_isOnlyMember" style="margin-right:15px;">관리자와 회원만 구매 가능 (비회원은 구매 불가)</label>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                ...
                KR : <input type="text" name="it_name" value="<?php echo get_text(cut_str($it['it_name'], 250, "")); ?>" id="it_name" required class="frm_input required" size="95">
				<br>
				<p style="margin-top:10px;">
				JP : <input type="text" name="it_name_jp" value="<?php echo get_text(cut_str($it['it_name_jp'], 250, "")); ?>" id="it_name_jp" class="frm_input" size="95">
				</p>
            </td>
        </tr>
        <tr>
            <th scope="row"><label for="it_jancode">JAN Code</label></th>
            <td colspan="2">
				<input type="text" name="it_jancode" value="<?php echo get_text(html_purifier($it['it_jancode'])); ?>" id="it_jancode" class="frm_input" size="40">
				<a href="javascript:checkJanCode();" class="btn_frmline">중복체크</a>
				<br>
				<span id="jancodeRes"></span>
			</td>
		</tr>
		<tr>
        ...
        <tr>
            ...
            <td>
                ...
                <label for="it_type1" style="margin-right:15px;">HOT <!-- <img src="<?php echo G5_SHOP_URL; ?>/img/icon_hit.gif" alt=""> --></label>
                <input type="checkbox" name="it_type2" value="1" <?php echo ($it['it_type2'] ? "checked" : ""); ?> id="it_type2">
                <label for="it_type2">신상품 <!-- <img src="<?php echo G5_SHOP_URL; ?>/img/icon_rec.gif" alt=""> --></label>
                <input type="checkbox" name="it_type3" value="1" <?php echo ($it['it_type3'] ? "checked" : ""); ?> id="it_type3">
                <label for="it_type3" style="margin-right:15px;">베스트 <!-- <img src="<?php echo G5_SHOP_URL; ?>/img/icon_new.gif" alt=""> --></label>
                <input type="checkbox" name="it_type4" value="1" <?php echo ($it['it_type4'] ? "checked" : ""); ?> id="it_type4">
                <label for="it_type4" style="margin-right:15px;">추천 <!-- <img src="<?php echo G5_SHOP_URL; ?>/img/icon_best.gif" alt=""> --></label>
                <input type="checkbox" name="it_type5" value="1" <?php echo ($it['it_type5'] ? "checked" : ""); ?> id="it_type5">
                <label for="it_type5" style="margin-right:15px;">할인 <!-- <img src="<?php echo G5_SHOP_URL; ?>/img/icon_discount.gif" alt=""> --></label>
            </td>
            <td class="td_grpset">
		...
		<tr>
            <th scope="row"><label for="it_useEvent">이벤트<br>(타임세일)</label></th>
            <td colspan="2">
                <?php //echo help("잠시 판매를 중단하거나 재고가 없을 경우에 체크를 해제해 놓으면 출력되지 않으며, 주문도 받지 않습니다."); ?>
                <input type="checkbox" name="it_useEvent" value="1" id="it_useEvent" <?php echo ($it['it_useEvent']) ? "checked" : ""; ?>> 사용
				<div style="padding-top:10px;">
				<?php
					$it_eventStartDateYmd = "";
					$it_eventStartDateHour = 0;
					$it_eventStartDateMinute = 0;
					$it_eventStartDateSecond = 0;
					if ($it['it_eventStartDate']) {
						$it_eventStartDateYmd = date("Y-m-d", $it['it_eventStartDate']);
						$it_eventStartDateHour = (int)date("H", $it['it_eventStartDate']);
						$it_eventStartDateMinute = (int)date("i", $it['it_eventStartDate']);
						$it_eventStartDateSecond = (int)date("s", $it['it_eventStartDate']);
					}

					$it_eventEndDateYmd = "";
					$it_eventEndDateHour = 0;
					$it_eventEndDateMinute = 0;
					$it_eventEndDateSecond = 0;
					if ($it['it_eventEndDate']) {
						$it_eventEndDateYmd = date("Y-m-d", $it['it_eventEndDate']);
						$it_eventEndDateHour = (int)date("H", $it['it_eventEndDate']);
						$it_eventEndDateMinute = (int)date("i", $it['it_eventEndDate']);
						$it_eventEndDateSecond = (int)date("s", $it['it_eventEndDate']);
					}
				?>

				시작일 <input type="text" name="it_eventStartDateYmd" value="<?php echo $it_eventStartDateYmd; ?>" id="it_eventStartDateYmd" class="frm_input" size="20" style="text-align:center;">
				<select id="it_eventStartDateHour" name="it_eventStartDateHour">
					<?php for ($h = 0; $h < 24; $h++) { ?>
					<option value="<?php echo $h; ?>" <?php if ($it_eventStartDateHour == $h) { echo "selected"; } ?>><?php echo $h; ?></option>
					<?php } ?>
				</select>시
				<select id="it_eventStartDateMinute" name="it_eventStartDateMinute">
					<?php for ($m = 0; $m < 60; $m++) { ?>
					<option value="<?php echo $m; ?>" <?php if ($it_eventStartDateMinute == $m) { echo "selected"; } ?>><?php echo $m; ?></option>
					<?php } ?>
				</select>분
				<select id="it_eventStartDateSecond" name="it_eventStartDateSecond">
					<?php for ($s = 0; $s < 60; $s++) { ?>
					<option value="<?php echo $s; ?>" <?php if ($it_eventStartDateSecond == $s) { echo "selected"; } ?>><?php echo $s; ?></option>
					<?php } ?>
				</select>초
				~
				종료일 <input type="text" name="it_eventEndDateYmd" value="<?php echo $it_eventEndDateYmd; ?>" id="it_eventEndDateYmd" class="frm_input" size="20" style="text-align:center;">
				<select id="it_eventEndDateHour" name="it_eventEndDateHour">
					<?php for ($h = 0; $h < 24; $h++) { ?>
					<option value="<?php echo $h; ?>" <?php if ($it_eventEndDateHour == $h) { echo "selected"; } ?>><?php echo $h; ?></option>
					<?php } ?>
				</select>시
				<select id="it_eventEndDateMinute" name="it_eventEndDateMinute">
					<?php for ($m = 0; $m < 60; $m++) { ?>
					<option value="<?php echo $m; ?>" <?php if ($it_eventEndDateMinute == $m) { echo "selected"; } ?>><?php echo $m; ?></option>
					<?php } ?>
				</select>분
				<select id="it_eventEndDateSecond" name="it_eventEndDateSecond">
					<?php for ($s = 0; $s < 60; $s++) { ?>
					<option value="<?php echo $s; ?>" <?php if ($it_eventEndDateSecond == $s) { echo "selected"; } ?>><?php echo $s; ?></option>
					<?php } ?>
				</select>초
				</div>
            </td>
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="it_price">상품무게</label></th>
            <td>
                <input type="text" name="it_weight" value="<?php echo $it['it_weight']; ?>" id="it_weight" class="frm_input" size="8"> g
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_weight" value="1" id="chk_ca_it_weight">
                <label for="chk_ca_it_weight">분류적용</label>
                <input type="checkbox" name="chk_all_it_weight" value="1" id="chk_all_it_weight">
                <label for="chk_all_it_weight">전체적용</label>
            </td>
        </tr>
...
function checkJanCode() {
	if ($("#it_jancode").val() == "")
	{
		alert("JAN Code를 입력하세요.");
		return;
	}

	$.ajax({
		url			: '/shop/ajax.action.php',
		type		: 'POST',
		dataType	: 'json',
		contentType	: 'application/x-www-form-urlencoded; charset=utf-8',
		data : {
			action : 'checkJanCode',
			janCode: $("#it_jancode").val()
		},
		success: function (response) {
			$("#jancodeRes").html(response.msg);			
		},
...
$(function(){
	$("#it_eventStartDateYmd, #it_eventEndDateYmd").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yy-mm-dd", showButtonPanel: true, yearRange: "c-99:c+99" });
});
</script>
