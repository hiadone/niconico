...
$it_name_jp = strip_tags(clean_xss_attributes(trim($_POST['it_name_jp'])));
...
$it_weight = isset($_POST['it_weight']) ? $_POST['it_weight'] : 0;
$it_useEvent = isset($_POST['it_useEvent']) ? $_POST['it_useEvent'] : 0;
$it_eventStartDateYmd = isset($_POST['it_eventStartDateYmd']) ? $_POST['it_eventStartDateYmd'] : null;
$it_eventStartDateHour = isset($_POST['it_eventStartDateHour']) ? $_POST['it_eventStartDateHour'] : 0;
$it_eventStartDateMinute = isset($_POST['it_eventStartDateMinute']) ? $_POST['it_eventStartDateMinute'] : 0;
$it_eventStartDateSecond = isset($_POST['it_eventStartDateSecond']) ? $_POST['it_eventStartDateSecond'] : 0;
$it_eventEndDateYmd = isset($_POST['it_eventEndDateYmd']) ? $_POST['it_eventEndDateYmd'] : null;
$it_eventEndDateHour = isset($_POST['it_eventEndDateHour']) ? $_POST['it_eventEndDateHour'] : 0;
$it_eventEndDateMinute = isset($_POST['it_eventEndDateMinute']) ? $_POST['it_eventEndDateMinute'] : 0;
$it_eventEndDateSecond = isset($_POST['it_eventEndDateSecond']) ? $_POST['it_eventEndDateSecond'] : 0;
$it_isOnlyAdmin = isset($_POST['it_isOnlyAdmin']) ? $_POST['it_isOnlyAdmin'] : 0;
$it_jancode = isset($_POST['it_jancode']) ? $_POST['it_jancode'] : null;

$eventStartDate = "";
$eventEndDate = "";
if ($it_eventStartDateYmd) {
	$eventStartDate = strtotime($it_eventStartDateYmd ." ". substr("0". $it_eventStartDateHour, -2) .":". substr("0". $it_eventStartDateMinute, -2) .":". substr("0". $it_eventStartDateSecond, -2));
}
if ($it_eventEndDateYmd) {
	$eventEndDate = strtotime($it_eventEndDateYmd ." ". substr("0". $it_eventEndDateHour, -2) .":". substr("0". $it_eventEndDateMinute, -2) .":". substr("0". $it_eventEndDateSecond, -2));
}
...
$sql_common = " ca_id               = '$ca_id',
                ...
                it_9                = '$it_9',
                it_10               = '$it_10',
				it_useEvent			= '$it_useEvent',
				it_eventStartDate	= '$eventStartDate',
				it_eventEndDate		= '$eventEndDate',
				it_isOnlyAdmin		= '$it_isOnlyAdmin',
				it_jancode			= '$it_jancode'
                ";
