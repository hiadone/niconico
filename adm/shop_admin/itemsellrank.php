...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        <th scope="col">순위</th>
        <th scope="col">상품명</th>
        <th scope="col"><a href="<?php echo title_sort("ct_status_1",1)."&amp;$qstr1"; ?>">조회</a></th>
...
$(function() {
	...
	$("#excelDownloadBtn").click(function(){
		$.download('excelPrint.php', 'action=itemsellrank&fr_date=<?php echo $fr_date; ?>&to_date=<?php echo $to_date; ?>&sel_ca_id=<?php echo $sel_ca_id; ?>', 'post');
	});
});
</script>
