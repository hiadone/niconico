...
<section id="anc_sodr_list">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for($i=0; $row=sql_fetch_array($result); $i++) {
			...
			// 총 무게
			$sql = " SELECT it_weight FROM {$g5['g5_shop_item_table']} WHERE it_id = '". $row['it_id'] ."' ";
			$iw = sql_fetch($sql);

			$tot_weight += $iw['it_weight'] * $sum['qty'];
...
<section id="anc_sodr_pay">
    ...
    $amount['order'] = $od['od_cart_price'] + $send_cost + $od['od_send_cost2'];
	...
	/*
	if ($send_cost > 0) {
		$od['od_misu'] = $od['od_misu'] + $send_cost;
	}
	*/
    ?>
        ...
        <section id="anc_sodr_chk" class="compare_left">
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="od_send_cost" value="<?php echo $send_cost; ?>" id="od_send_cost" class="frm_input" size="10"> 원
                    </td>
                </tr>
    ...
    <div class="compare_wrap">
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    ...
                    <td>
						...
						<input type="text" name="od_addr_eng" value="<?php echo get_text($od['od_addr_eng']); ?>" id="od_addr_eng" class="frm_input" size="35">
                        <label for="od_addr_eng">영문주소</label>
                    </td>
                </tr>
                <tr>
        ...
        <section id="anc_sodr_taker" class="compare_right">
            ...
            <div class="tbl_frm01">
				...
				<tr>
                    <th scope="row"><label for="od_b_name_en"><span class="sound_only">받으시는 분 </span>영문명</label></th>
                    <td><input type="text" name="od_b_name_en" value="<?php echo get_text($od['od_b_name_en']); ?>" id="od_b_name_en" required class="frm_input required"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_b_tel"><span class="sound_only">받으시는 분 </span>전화번호</label></th>
                    <td><input type="text" name="od_b_tel" value="<?php echo get_text($od['od_b_tel']); ?>" id="od_b_tel"  class="frm_input "></td>
                </tr>
                <tr>
				...
				<tr>
                    <th scope="row"><label for="od_b_num"><span class="sound_only">받으시는 분 </span>개인통관고유번호</label></th>
                    <td><input type="text" name="od_b_num" value="<?php echo get_text($od['od_b_num']); ?>" id="od_b_num" class="frm_input required"></td>
                </tr>
                <tr>
                    ...
                    <td>
						...
						<input type="text" name="od_b_addr_eng2" value="<?php echo get_text($od['od_b_addr_eng2']); ?>" id="od_b_addr_eng2" class="frm_input" size="35">
                        <label for="od_b_addr_eng2">영문주소 상세</label>
						<input type="text" name="od_b_addr_eng" value="<?php echo get_text($od['od_b_addr_eng']); ?>" id="od_b_addr_eng" class="frm_input" size="35">
                        <label for="od_b_addr_eng">영문주소</label>
                    </td>
                </tr>
