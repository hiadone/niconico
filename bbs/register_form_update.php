...
$mb_name_en     = trim($_POST['mb_name_en']);
...
$mb_addr_eng	= isset($_POST['mb_addr_eng'])		? trim($_POST['mb_addr_eng'])	 : "";
$mb_addr_eng2	= isset($_POST['mb_addr_eng2'])		? trim($_POST['mb_addr_eng2'])	 : "";
...
$mb_addr_eng    = clean_xss_tags($mb_addr_eng);
$mb_addr_eng2   = clean_xss_tags($mb_addr_eng2);
...
if ($w == '') {
    $sql = " insert into {$g5['member_table']}
                set mb_id = '{$mb_id}',
					 ...
					 mb_addr_eng = '{$mb_addr_eng}',
					 mb_addr_eng2 = '{$mb_addr_eng2}',
