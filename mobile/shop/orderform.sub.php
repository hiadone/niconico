...
?>
    ...
    <ul class="sod_list">
        ...
        <li class="sod_li">
            ...
            <div class="li_prqty">
                <span class="prqty_price li_prqty_sp"><span>판매가 </span><?php 
					if ($row['it_useEvent'] == 1) {
    ...
    <div class="sod_ta_wr">
        <dl id="m_sod_bsk_tot">
			...
			<dt class="sod_bsk_point">총 무게</dt>
            <dd class="sod_bsk_point"><strong><?php echo number_format($tot_weight); ?> g</strong></dd>
        ...
        <div class="odf_list">
            <ul>
                ...
                <li>
                    ...
                    <input type="text" name="od_hp" value="<?php echo get_text($member['mb_hp']); ?>" id="od_hp" class="frm_input required" required maxlength="20">
                </li>
<style>
	input.readonly { background-color:#f2f2f2; }
                ...
                <li>
                    ...
                    <input type="number" name="od_zip" value="<?php echo $member['mb_zip1'].$member['mb_zip2']; ?>" id="od_zip" required class="frm_input required" size="5" maxlength="6" style="width:100px !important;" placeholder="우편번호">
                    <button type="button" class="btn_frmline btn_addsch" onclick="win_zip('forderform', 'od_zip', 'od_addr1', 'od_addr2', 'od_addr3', 'od_addr_jibeon', 'od_addr_eng');">주소검색</button></span>
					...
					<label for="od_addr_eng" class="sound_only">영문주소</label>
                    <input type="text" name="od_addr_eng" value="<?php echo get_text($member['mb_addr_eng']) ?>" id="od_addr_eng" class="frm_input frm_address readonly" readonly placeholder="영문주소">
    ...
    <section id="sod_frm_taker">
        ...
        <div class="odf_list">
            <ul>
                ...
                ?>
                <li>
                    <label for="od_b_name">한글명<strong class="sound_only"> 필수</strong></label>
                    <input type="text" name="od_b_name" id="od_b_name" required class="frm_input required" maxlength="20">
                </li>
				<li>
                    <label for="od_b_name">영문명<strong class="sound_only"> 필수</strong></label>
                    <input type="text" name="od_b_name_en" id="od_b_name_en" required class="frm_input required" maxlength="20">
                </li>
				<li>
					<label for="od_b_num">개인통관고유번호<strong class="sound_only"> 필수</strong></label>
                    <td>
                ...
                <li>
                    ...
                    <span class="add_num"><input type="number" name="od_b_zip" id="od_b_zip" required class="frm_input required" size="5" maxlength="6" style="width:100px !important;" placeholder="우편번호">
                    <button type="button" class="btn_frmline  btn_addsch" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon', 'od_b_addr_eng');">주소 검색</button></span>
					...
					<label for="od_b_addr_eng" class="sound_only">영문주소</label>
                    <input type="text" name="od_b_addr_eng" id="od_b_addr_eng" class="frm_input frm_address readonly" readonly placeholder="영문주소">
