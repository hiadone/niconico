...
<div id="mb_login" class="mbskin">
	...
	<h1><a href="/"><img src="https://www.niconicomall.com/data/common/logo_img?v=202012011132" alt=""/></a></h1>
...
<style>
.login-bth-group { width:100%; text-align:center; margin-top:0px; }
.login-bth-group .btnL { display: inline-block; color:#000 !important;width:50% !important; border:1px solid #ddd !important; padding:12px 0 !important; border-radius:0 !important; line-height:15px;}
.login-bth-group .btnL + .btnL { position:relative; left:-1px; }
.login-bth-group .btnR { display:block; color:#000 !important;width:100% !important; border:1px solid #ddd !important; padding:12px 0 !important; border-radius:0 !important; line-height:15px; margin-top:5px;}
</style>
    <section class="mb_login_join">
        <h2>회원로그인 안내</h2>

		<div class="login-bth-group">
			<a href="<?php echo G5_BBS_URL ?>/id_lost.php" target="_blank" id="login_id_lost" class="btnL">아이디 찾기</a>
			<a href="<?php echo G5_BBS_URL ?>/password_lost.php" id="login_password_lost" class="btnL">비밀번호 찾기</a>
			<a href="./register.php" class="btnR">회원 가입</a>
		</div>
    </section>
    </form>
    ...
    <section id="mb_login_notmb" class="mbskin">
        ...
        <div class="chk_box">
		   ...
		   <label for="agree" style="position:relative;"><span style="left:-10px;"></span>개인정보수집에 대한 내용을 읽었으며 이에 동의합니다.</label>
	   </div>
