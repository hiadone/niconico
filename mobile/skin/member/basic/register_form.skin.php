    ...
    <div class="form_01">
        ...
        <ul>
	        <li>
	            ...
	            <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" <?php echo $required ?> <?php echo $readonly ?> placeholder="id" style="display:inline-block;width:70%;" />
				<?php
					if ($w == '') {
				?>
				<button type="button" onclick="mb_id_check();" style="display:inline-block;width:29%;border: 0; background: #3a8afd;color: #fff;cursor: pointer;border-radius: 3px;height: 38px;padding: 0 30px;font-weight: bold;font-size: 1.083em;">중복확인</button>
				<?php
					}
				?>
	            <span id="msg_mb_id" style="display:block;color:red;padding:5px 0;"></span>
    ...
    <div class="form_01">
        ...
        <ul>
	        <li class="rgs_name_li">
	            <label for="reg_mb_name" class="sound_only">한글명<strong>필수</strong></label>
	            <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> class="frm_input full_input <?php echo $required ?> " placeholder="한글명">
	            <?php
			...
			<li>
			 <label for="reg_mb_name_en" class="sound_only">영문명<strong>필수</strong></label>
	            <input type="text" id="reg_mb_name_en" name="mb_name_en" value="<?php echo get_text($member['mb_name_en']) ?>" <?php echo $required ?>  class="frm_input full_input <?php echo $required ?>" placeholder="영문명">
			</li>
	        <?php if ($req_nick) { ?>
	        <li>
			...
			<li class="chk_box">
				<label for="reg_mb_birth" class="sound_only">생년월일<strong class="sound_only">필수</strong></label>
				<input type="number" name="mb_1" id="reg_mb_birth" class="frm_input required" required placeholder="생년월일 ex) 190520" style="width:160px;" value="<?php echo isset($member['mb_1'])?$member['mb_1']:'';?>" />
				<div class="reg_mb_sex_group">
					<input type="radio" name="mb_2" id="reg_sex1" <?php if (isset($member['mb_2']) && $member['mb_2'] == 'f') { echo "checked"; } ?> /><label for="reg_sex1"><span></span> 여성</label>
				</div>
				<div class="reg_mb_sex_group">
					<input type="radio" name="mb_2" id="reg_sex2" <?php if (isset($member['mb_2']) && $member['mb_2'] == 'm') { echo "checked"; } ?> /><label for="reg_sex2"><span></span> 남성</label>
				</div>
			</li>
	...
	input.readonly { background-color:#f2f2f2; }
	        ...
	        <li>
	        	<div class="adress">
	            	...
	            	<button type="button" class="btn_frmline" onclick="win_zip('fregisterform', 'mb_zip', 'mb_addr1', 'mb_addr2', 'mb_addr3', 'mb_addr_jibeon', 'mb_addr_eng');">주소검색</button><br>
	            </div>
				...
				<br>
	            <label for="reg_mb_addr_eng" class="sound_only">영문주소</label>
	            <input type="text" name="mb_addr_eng" value="<?php echo get_text($member['mb_addr_eng']) ?>" id="reg_mb_addr_eng" class="frm_input frm_address readonly" size="50"  placeholder="영문주소" readonly>
				<input type="text" name="mb_addr_eng2" value="<?php echo get_text($member['mb_addr_eng2']) ?>" class="frm_input frm_address" size="40" placeholder="상세 영문주소" />
				<summary style="color:red;padding:10px 0;">
