...
<aside id="ol_after">
    ...
    <div id="ol_after_hd" class="ol">
        ...
        <strong class="nickname"><?php echo $member['mb_name']; ?> 님</strong>
...
<?php }else{ ?>
		<li><a href="javascript:alert('보유중인 쿠폰이 없습니다');"><i class="fa fa-ticket" aria-hidden="true"></i>쿠폰<strong><?php echo number_format($cp_count); ?></strong></a></li>
<?php } ?>
    </ul>
