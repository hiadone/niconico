...
<div id="sit_ov_wrap">
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
		...
		?>
		<div id="timeSaleDiv">
			<h3 style="margin-bottom:5px;">판매 남은 시간</h3>
			<div id="remainTimeDiv" style="text-align:center;background-color:red; padding:5px 0;margin-bottom:5px;"><span id="remainTimeTxt" style="color:#fff;font-size:18px;font-weight:400;"></span></div>
		</div>
		<script>
			function startTimer() {
            ...
            <div id="sit_star_sns">
                ...
                <div class="sit_btn_opt">
                    ...
                    <div class="sns_area">
                        ...
                        <?php // 구글 플러스 서비스 안함 echo get_sns_share_link('googleplus', $sns_url, $sns_title, G5_MSHOP_SKIN_URL.'/img/gplus.png'); ?>
...
<div id="btn_option">
	...
	<style>
	/* 모비온 이슈로 스타일 id > class 로*/
	.m_sit_btn_cart { float: left;
		width: 39%;
		margin-right: 1%;
		line-height: 50px;
	...
	.m_sit_btn_wish { 
        ...
        <div id="sit_ov_btn">
            <?php if ($is_orderable) { ?>
            <input type="submit" onclick="document.pressed=this.value;" value="장바구니" id="cartBtn" class="m_sit_btn_cart">
            ...
            <?php } ?>
            <a id="wishBtn" href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" class="m_sit_btn_wish"><span class="sound_only">위시리스트</span><i class="fa fa-heart-o" aria-hidden="true"></i></a>
	...
	$(document).ready(function() {
	  $(document).scroll(function(){
		var docScroll = $(document).scrollTop(),
			boxCntOfset = $("#sit_tab").offset().top -90;
		//when rich top of boxex than fire
		if(docScroll >= boxCntOfset ) {
		  $(".tab_tit").addClass('active');
		  $(".tab_con").css("padding-top","55px");
		} else {
		 $(".tab_tit").removeClass('active');
		  $(".tab_con").css("padding-top","15px");
		}
	  })   
	});
</script>
...
<div id="sit_tab">
	<?php
		/* 사용후기 개수 */
		$query = " SELECT count(*) as cnt FROM g5_shop_item_use WHERE it_id = '". $it['it_id'] ."' AND is_confirm = '1' AND is_status = 1 ";
		$res = sql_fetch($query);
	?>
    <ul class="tab_tit">
        <li><button type="button" rel="#sit_inf" class="selected">상품정보</button></li>
        <li><button type="button" rel="#sit_use">사용후기 (<?php echo $res['cnt']; ?>)</button></li>
...
<style>
	#sit_ex img,
	#sit_dvr img { max-width:100% !important; }
</style>
            <div id="sit_dvr">
                <h3>배송정보</h3>
...
<div id="layerbox2" class="layerpop2">
	...
	<div class="content">
		...
		<button id="goCartPageBtn" class="sec sec1" onclick="location.href='/shop/cart.php';">장바구니로</button>
	</div>
	</article>
</div>
