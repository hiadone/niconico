...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <tr>
            ...
            <?php /* <th scope="col" style="<?php echo $th_st; ?>">옵션</th> */?>
        ...
        <?php //for ($h=0; $h<count($cart_list); $h++) { 
			...
			if (count($cart_list) > 1) {
				$extraCnt = count($cart_list) - 1;
				$addTitle = "외 ". $extraCnt;
			}
		?>
        <tr>
            <td style="<?php echo $td_st; ?>"><a href="<?php echo shop_item_url($cart_list[$h]['it_id']); ?>" target="_blank" style="text-decoration:none"><?php echo $cart_list[$h]['it_name']; ?></a> <?php echo $addTitle; ?></td>
            <?php /* <td style="<?php echo $td_st; ?>;text-align:center"><?php echo $cart_list[$h]['it_opt']; </td>*/ ?>
