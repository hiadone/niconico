...
<div id="sod_frm" class="sod_frm_pc">
    ...
    <div class="tbl_head03 tbl_wrap od_prd_list">
        ...
        $sql = " select a.ct_id,
                  ...
                  where a.od_id = '$s_cart_id'
                    and a.ct_select = '1' and b.it_use = 1 ";
        ...
        <tr>
            ...
            <td class="td_numbig  text_right">
				<?php 
					if ($row['it_useEvent'] == 1) {
						echo "<strike>". number_format($row['it_cust_price']) ."</strike><br>"; 
					}
			...
			<td class="td_numbig  text_right"><?php echo number_format($tWeight); ?>g</td>
	...
	<p style="color:red;" class="fixopt">
		1. 건강기능식품은 관세법상 통관 기준인 1인당 6개까지 구매하실 수 있습니다.<br/>
		2. 1회 통관 시 배송비 제외 상품금액 150$ (한화 17만원)이내에서 면세입니다. 이를 초과할 시에는 추가 관세가 발생할 수 있습니다.<br/>
		3. 국제배송비는 상품 무게에 따라 측정되며 500g 기준 8,500원 입니다. <a href="/bbs/content.php?co_id=delivery" target="_blank"><u>(무게별 배송비 보기)</u></a>
	</p>
    ...
    <div class="sod_left">
        ...
        <section id="sod_frm_orderer">
            ...
            <div class="tbl_frm01 tbl_wrap">
				...
				<tr>
                    <th scope="row"><label for="od_name_en">영문명<strong class="sound_only"> 필수</strong></label></th>
                    <td><input type="text" name="od_name_en" value="<?php echo get_text($member['mb_name_en']); ?>" id="od_name_en" required class="frm_input required" maxlength="20" style="width:40%;"></td>
                </tr>
	...
	input.readonly { background-color:#f2f2f2; }
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn_address" onclick="win_zip('forderform', 'od_zip', 'od_addr1', 'od_addr2', 'od_addr3', 'od_addr_jibeon', 'od_addr_eng');">주소 검색</button><br>
						...
						<input type="text" name="od_addr_eng2" value="<?php echo get_text($member['mb_addr_eng2']) ?>" class="frm_input frm_address required" required size="20" placeholder="상세 영문주소" style="width:auto;display:inline-block;" />
						<input type="text" name="od_addr_eng" value="<?php echo get_text($member['mb_addr_eng']) ?>" id="od_addr_eng" class="frm_input frm_address readonly" size="55" placeholder="영문주소" readonly style="width:auto;display:inline-block;">
                        <label for="od_addr_eng" class="sound_only">참고항목</label>
						<summary style="color:red;line-height:1.5;">
							* 기본 영문주소는 한글주소 입력시 자동으로 등록 됩니다.<br/>
							* 상세 영문주소는 추가로 기입해 주세요.
						</summary>
                    </td>
                </tr>
                <tr>
        ...
        <section id="sod_frm_taker">
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <?php } ?>
                <tr>
                    <th scope="row"><label for="od_b_name">한글명<strong class="sound_only"> 필수</strong></label></th>
                    <td><input type="text" name="od_b_name" id="od_b_name" required class="frm_input required" maxlength="20"></td>
                </tr>
				<tr>
                    <th scope="row"><label for="od_b_name_en">영문명<strong class="sound_only"> 필수</strong></label></th>
                    <td><input type="text" name="od_b_name_en" id="od_b_name_en" required class="frm_input required" maxlength="20"></td>
                </tr>
				<tr>
                    <th scope="row"><label for="od_b_num">개인통관고유번호<strong class="sound_only"> 필수</strong></label></th>
                    <td>
						<input type="text" name="od_b_num" value="" id="od_b_num" required class="frm_input required" maxlength="20" placeholder="ex) 13자리 -  P123451234512"/>
						<a href="/bbs/content.php?co_id=service" target="_blank" style="margin-right:10px;color:#2954cf;"><i class="fa fa-question-circle-o" aria-hidden="true"></i> 구매대행 안내사항</a>
						<a href="https://unipass.customs.go.kr/csp/persIndex.do" target="_blank" style="color:#2954cf;"><i class="fa fa-question-circle-o" aria-hidden="true"></i> 통관부호 발급 및 조회</a>
					</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td id="sod_frm_addr">
                        ...
                        <button type="button" class="btn_address" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon', 'od_b_addr_eng');">주소 검색</button><br>
						...
						<input type="text" name="od_b_addr_eng2"  class="frm_input frm_address required" required size="20" placeholder="상세 영문주소" style="width:auto;display:inline-block;" />
						<input type="text" name="od_b_addr_eng" id="od_b_addr_eng" class="frm_input frm_address readonly" size="55" placeholder="영문주소" style="width:auto;display:inline-block;" readonly>
                        <label for="od_b_addr_eng" class="sound_only">영문주소</label><br>
						<summary style="color:red;line-height:1.5;">
							* 기본 영문주소는 한글주소 입력시 자동으로 등록 됩니다.<br/>
							* 상세 영문주소는 추가로 기입해 주세요.
						</summary>
                ...
                <tr>
                    <th scope="row"><label for="od_memo">택배사 요청</label></th>
            ...
            <div class="pay_tbl">
                ...
                <tr>
                    <td colspan="2" style="text-align:center;">
                        총 <strong><?php echo number_format($discountPrice); ?></strong>원 할인되었습니다.
                    </td>
                </tr>
                <?php } ?>
...
$(function() {
	...
	$("#od_temp_point").on("keyup", function(){
		if ($(this).val() == '')
		{
			var pointValue = 0;
		} else {
			var pointValue = addComma(parseInt(removeCommas($(this).val().replace(/[^0-9]/g,""))));
		}
		$(this).val(pointValue);
		aPrice = parseInt(parseInt(removeCommas($("#ct_tot_price").html())) - parseInt(removeCommas(pointValue)));
		$(".print_price").text(addComma(parseInt(aPrice)));
	});
});
...
function forderform_check(f)
{
    ...
    check_field(f.od_zip, "우편번호는 필수 입니다");
	...
	check_field(f.od_b_name_en, "받으시는 분 영문이름을 입력하십시오.");
    check_field(f.od_b_hp, "받으시는 분 전화번호를 입력하십시오.");
    check_field(f.od_b_addr1, "주소검색을 이용하여 받으시는 분 주소를 입력하십시오.");
    //check_field(f.od_b_addr2, "받으시는 분의 상세주소를 입력하십시오.");
    check_field(f.od_b_zip, "우편번호는 필수 입니다");
	...
	check_field(f.od_b_num, "개인통관번호를 입력하여 주세요.");
	if (f.od_b_num.value.length != 13 || f.od_b_num.value.substring(0, 1).toLocaleUpperCase() != 'P')
	{
		error_field(f.od_b_num, "통관번호가 잘못 되었습니다. 다시 확인 해 주세요.");
	}
    ...
    if (typeof(f.od_temp_point) != "undefined") {
        ...
        {
            var point_unit = parseInt(<?php echo $default['de_settle_point_unit']; ?>);
            temp_point = parseInt(removeCommas(f.od_temp_point.value));
...
function gumae2baesong() {
	...
	f.od_b_name_en.value = f.od_name_en.value;
	...
	f.od_b_addr_eng.value = f.od_addr_eng.value;
	f.od_b_addr_eng2.value = f.od_addr_eng2.value;
