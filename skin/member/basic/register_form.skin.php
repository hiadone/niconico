...
<?php } ?>
	...
	<div id="register_form" class="form_01">   
	    <div class="register_form_inner">
	        ...
	        <ul>
	            <li class="half_input left_input margin_input">
	                ...
	                <span id="msg_mb_id" style="display:inline-block;color:red;margin-top:10px;"></span>
	            </li>
				<li class="half_input left_input">
					<?php
						if ($w == '') {
					?>
					<label style="visibility: hidden;">중복확인</label>
					<a href="javascript:mb_id_check();" class="btn" style="display:inline-block;height:40px;line-height:38px;background:#06961e;font-size:14px;color:#fff;margin-top:5px;width:100px;border-radius:3px;">중복확인</a>
					<?php
						}
					?>
				</li>
	    ...
	    <div class="tbl_frm01 tbl_wrap register_form_inner">
	        ...
	        <ul>
	            <li class="half_input left_input margin_input">
	                <label for="reg_mb_name">한글명<strong class="sound_only">필수</strong></label>
	                <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> class="frm_input full_input <?php echo $required ?>" size="10" placeholder="한글명">
	                <?php
				...
				<li class="half_input left_input">
					<label for="reg_mb_name_en">영문명<strong class="sound_only">필수</strong></label>
					<input type="text" id="reg_mb_name_en" name="mb_name_en" value="<?php echo get_text($member['mb_name_en']) ?>" <?php echo $required ?> class="frm_input full_input <?php echo $required ?>" size="10" placeholder="영문명">
				</li>
	            <?php if ($req_nick) {  ?>
	            <li>
				...
				<li class="chk_box">
					<label for="reg_mb_birth">생년월일<strong class="sound_only">필수</strong></label>
					<input type="number" name="mb_1" id="reg_mb_birth" class="frm_input required" required placeholder="ex) 190520" value="<?php echo isset($member['mb_1'])?$member['mb_1']:'';?>" />
					<div class="reg_mb_sex_group">
						<input type="radio" name="mb_2" id="reg_sex1" value="f" <?php if (isset($member['mb_2']) && $member['mb_2'] == 'f') { echo "checked"; } ?> /><label for="reg_sex1"><span></span> 여성</label>
					</div>
					<div class="reg_mb_sex_group">
						<input type="radio" name="mb_2" id="reg_sex2" value="m" <?php if (isset($member['mb_2']) && $member['mb_2'] == 'm') { echo "checked"; } ?> /><label for="reg_sex2"><span></span> 남성</label>
					</div>
				</li>
...
<style>
	input.readonly { background-color:#f2f2f2; }
	            ...
	            <li>
	                ...
	                <button type="button" class="btn_frmline" onclick="win_zip('fregisterform', 'mb_zip', 'mb_addr1', 'mb_addr2', 'mb_addr3', 'mb_addr_jibeon', 'mb_addr_eng');">주소 검색</button><br>
					...
					<input type="text" name="mb_addr_eng" value="<?php echo get_text($member['mb_addr_eng']) ?>" id="reg_mb_addr_eng" class="frm_input frm_address readonly" size="80" placeholder="영문주소" readonly>
					<summary style="color:red;margin-top:10px;">
...
function fregisterform_submit(f)
{
	...
	//f.mb_2.value = f.reg_mb_sex.value;
	/*
